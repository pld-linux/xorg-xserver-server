...
graficznej. Do dziaЁania wymaga odpowiedniego sterownika.
...
zachowuje siЙ jak klient X w stosunku do prawdziwego serwera X, a jak
serwer X dla wЁasnych klientСw.
...
Xprt to serwer wydrukСw Xprint dla X Window System dla urz╠dzeЯ nie
...
Xvfb (X Virtual Frame Buffer) jest serwerem X, ktСry mo©na uruchamiaФ
...
u©ywany do testowania serwerСw X, mo©e te© byФ u©ywany do testowania
klientСw X w rzadko u©ywanych konfiguracjach ekranu. Mo©na te© u©yФ
Xvfb do uruchomienia aplikacji, ktСre w rzeczywisto╤ci nie wymagaj╠
serwera X, ale odmawiaj╠ uruchomienia bez niego.

%package devel
Summary:	Header files for X.org server
Summary(pl):	Pliki nagЁСwkowe dla servera X.org
...
Pliki nagЁСwkowe dla serwera X.org.
